...
# BASE PROJECT PATH
# --------------------------------------------------
BASE_PATH = "Portfolio_App/data-analytics-portfolio"
...
def get_file_as_base64(file_path: str):
    """Works for both images and SVG icons"""
...
if submitted:
    st.success("Thank you for your feedback!")import streamlit as st
import base64
import os
...
@st.cache_data
def get_svg_as_base64(file_path: str):
    if os.path.exists(file_path):
        with open(file_path, "rb") as f:
            return base64.b64encode(f.read()).decode()
    return None
...
# Background Styling
# --------------------------------------------------
background_path = "background/banner.jpg"
